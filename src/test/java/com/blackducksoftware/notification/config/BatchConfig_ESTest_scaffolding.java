...
public class BatchConfig_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.blackducksoftware.notification.config.BatchConfig"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BatchConfig_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.blackducksoftware.notification.config.BatchConfig",
      ...
      "com.blackducksoftware.notification.batch.reader.NotificationReader",
      ...
      "com.blackducksoftware.notification.batch.processor.NotificationProcessor",
      ...
      "com.blackducksoftware.notification.model.DateRange",
      ...
      "com.blackducksoftware.notification.batch.processor.JobCompletionNotificationListener",
...
//    mock(Class.forName("com.blackducksoftware.notification.batch.processor.JobCompletionNotificationListener", false, BatchConfig_ESTest_scaffolding.class.getClassLoader()));
//    mock(Class.forName("com.blackducksoftware.notification.config.JMSConfig", false, BatchConfig_ESTest_scaffolding.class.getClassLoader()));
//    mock(Class.forName("com.blackducksoftware.notification.config.NotificationConfig", false, BatchConfig_ESTest_scaffolding.class.getClassLoader()));
//    mock(Class.forName("org.apache.logging.log4j.spi.LoggerContextFactory", false, BatchConfig_ESTest_scaffolding.class.getClassLoader()));
//    mock(Class.forName("org.springframework.batch.core.configuration.annotation.JobBuilderFactory", false, BatchConfig_ESTest_scaffolding.class.getClassLoader()));
//    mock(Class.forName("org.springframework.batch.core.configuration.annotation.StepBuilderFactory", false, BatchConfig_ESTest_scaffolding.class.getClassLoader()));
//    mock(Class.forName("org.springframework.batch.core.job.builder.JobBuilder", false, BatchConfig_ESTest_scaffolding.class.getClassLoader()));
//    mock(Class.forName("org.springframework.batch.core.launch.support.SimpleJobLauncher", false, BatchConfig_ESTest_scaffolding.class.getClassLoader()));
//    mock(Class.forName("org.springframework.batch.core.step.builder.SimpleStepBuilder", false, BatchConfig_ESTest_scaffolding.class.getClassLoader()));
//    mock(Class.forName("org.springframework.batch.core.step.builder.StepBuilder", false, BatchConfig_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BatchConfig_ESTest_scaffolding.class.getClassLoader()); 
