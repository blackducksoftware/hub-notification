...
public class NotificationProcessor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.blackducksoftware.notification.batch.processor.NotificationProcessor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NotificationProcessor_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.blackducksoftware.integration.hub.dataservice.model.ProjectVersionModel",
      ...
      "com.blackducksoftware.integration.hub.dataservice.notification.model.NotificationContentItem",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.blackducksoftware.integration.hub.dataservice.notification.NotificationResults", false, NotificationProcessor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.blackducksoftware.notification.config.JMSConfig", false, NotificationProcessor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.blackducksoftware.notification.config.NotificationConfig", false, NotificationProcessor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Function", false, NotificationProcessor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.logging.log4j.spi.LoggerContextFactory", false, NotificationProcessor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.springframework.jms.core.JmsTemplate", false, NotificationProcessor_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(NotificationProcessor_ESTest_scaffolding.class.getClassLoader()); 
